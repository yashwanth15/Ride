...
public class CustomerMapActivity extends AppCompatActivity implements OnMapReadyCallback,GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener, RoutingListener {
    ...
    private Button mShowDrivers;

    public LatLng driverLocationLatLng,driverDestinationLatLng;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mShowDrivers=(Button)findViewById(R.id.showDrivers);

        mShowDrivers.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void getRiderLocation(final  String driverFoundId){
        ...
        driverLocationRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    driverLocationLatLng=new LatLng(locationLat,locationLng);
                    Marker mDriverLocationMarker=mMap.addMarker(new MarkerOptions().position(driverLocationLatLng).title(""+markersCount));
        ...
        //DESTINATION
        final DatabaseReference driverDestinationRef=FirebaseDatabase.getInstance().getReference().child("driversAvailableDestination").child(driverFoundId).child("l");
        driverDestinationRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    driverDestinationLatLng=new LatLng(locationLat,locationLng);
                    Marker mDriverDestinationMarker=mMap.addMarker(new MarkerOptions().position(driverDestinationLatLng).title(""+markersCount));
                    if (driverFoundId!=null && driverDestinationLatLng!=null){
                        markersLocation.put(driverFoundId,driverDestinationLatLng);
                    }
                    if (driverDestinationLatLng!=null&&driverLocationLatLng!=null){
                        polylines.clear();
                        getRiderRoute();
                    }
                }
    ...
    public void getRiderRoute() {

        Routing routing = new Routing.Builder()
                .travelMode(AbstractRouting.TravelMode.DRIVING)
                .withListener(this)
                .alternativeRoutes(false)
                .waypoints(driverLocationLatLng, driverDestinationLatLng)
                .build();
        routing.execute();
    }
